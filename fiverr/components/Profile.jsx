...
function Profile() {
    ...
    const setProfile = async () => {
        const { userName, fullName, description } = data;
        ...
        try {
            ...
            if (err.response && err.response.data) {
                setErrorMessage(typeof err.response.data === "string" ? err.response.data : "Failed to update profile.");
            } else {
    ...
    if (!isLoaded) return <div className="h-[80vh] flex items-center justify-center font-bold text-2xl text-fiverr-gray animate-pulse">Loading profile...</div>;
    ...
    return (
        <>
            <div className="flex flex-col items-center justify-start min-h-[80vh] gap-3">
                    ...
                    <h2 className="text-3xl">Welcome to SkillBridge</h2>
                    ...
                    <div className="flex flex-col items-center w-full gap-5">
                        ...
                        <div className="flex gap-4">
                            ...
                            {userInfo?.role === "admin" && (
                                <button
                                    className="border text-lg font-semibold px-5 py-3 border-purple-600 bg-purple-600 text-white rounded-md"
                                    type="button"
