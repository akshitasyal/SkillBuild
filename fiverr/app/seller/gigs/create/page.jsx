...
function CreateGigs() {
    ...
    const inputClassName =
        "block p-4 w-full text-sm text-[#404145] border border-[#dadbdd] rounded focus:ring-fiverr-green focus:border-fiverr-green outline-none transition-all";
    const labelClassName = "mb-2 text-sm font-bold text-[#404145] block uppercase tracking-wider";
    ...
    const addGig = async () => {
        ...
        if (
            ...
            try {
                ...
                console.error(err);
                toast.error("Failed to create gig. Please try again.", { id: loadingToast });
            }
        } else {
            if (price < 35) {
                toast.error("Gig price must be at least ₹35.");
            } else {
    ...
    return (
        <div className="min-h-[80vh] py-16 px-6 md:px-0">
            <div className="max-w-5xl mx-auto">
                <div className="mb-12">
                    <h1 className="text-4xl font-bold text-[#404145] mb-2 tracking-tight">Create a new Gig</h1>
                    <p className="text-[#62646a] text-lg">Enter the details below to reach thousands of potential buyers.</p>
                </div>
                <form action="" className="bg-white border border-[#dadbdd] p-8 md:p-12 shadow-sm rounded-lg flex flex-col gap-8">
                ...
                <div className="grid grid-cols-2 gap-11">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                        />
                        <p className="text-xs text-[#62646a] mt-2 font-medium">
                            Minimum price: <span className="text-fiverr-green font-bold">₹35</span>
                            <span className="ml-1 text-[#95979d]">(Required for secure payment processing)</span>
                        </p>
                    </div>
                </div>
                <div className="pt-8 border-t border-[#dadbdd] flex justify-end">
                    <button
                        className="bg-fiverr-green text-white font-bold text-lg px-12 py-4 rounded hover:bg-[#19a463] transition-all shadow-md"
                        type="button"
                        onClick={addGig}
                    >
                        Create Gig
